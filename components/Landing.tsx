...
/* ────────────────────────────────────────────────────────────
   PUBLIC LANDING PAGE — shared by:
     - /          (app/page.tsx, for signed-out visitors)
    ...
    <section className="relative overflow-hidden border-b border-border1/50">
      <div className="absolute inset-0 pointer-events-none animate-aura">
        <div
          ...
          style={{ background: "radial-gradient(ellipse 60% 50% at 50% 0%, rgba(52,211,153,0.18), transparent 60%)" }}
        />
      </div>
      <div className="absolute inset-0 pointer-events-none animate-aura" style={{ animationDelay: "2s" }}>
        <div
          className="absolute inset-0"
          style={{ background: "radial-gradient(ellipse 55% 40% at 78% 8%, rgba(31,122,82,0.18), transparent 65%)" }}
        />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 pt-16 sm:pt-24 pb-12 sm:pb-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-14 sm:mb-20 animate-rise delay-3">
          <Link href="/register" className="btn-mint text-base !px-7 !py-3.5 inline-flex items-center justify-center gap-2 group animate-glow">
            Start free
          ...
          <Link href="/login" className="btn-ghost text-base !px-7 !py-3.5 inline-flex items-center justify-center">
            I have an account
          </Link>
        </div>
    ...
    <section id="features" className="border-b border-border1/50 py-20 sm:py-28">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <div className="text-center mb-14">
          <div className="text-[11px] font-bold uppercase tracking-[0.2em] text-mint mb-3">What you get</div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
          <FeatureCard delay={1} icon={<IconTarget />} title="ATR-based smart stops"
          ...
          <FeatureCard delay={2} icon={<IconChart />} title="ML drop-probability signals"
          ...
          <FeatureCard delay={3} icon={<IconBell />} title="Multi-channel alerts"
          ...
          <FeatureCard delay={4} icon={<IconCpu />} title="Hands-off execution"
          ...
          <FeatureCard delay={5} icon={<IconTrending />} title="Real performance dashboard"
          ...
          <FeatureCard delay={6} icon={<IconZap />} title="Built-in backtest engine"
  ...
  return (
    <section id="how" className="border-b border-border1/50 py-20 sm:py-28 bg-card/30">
      <div className="max-w-4xl mx-auto px-5 sm:px-8">
        <div className="text-center mb-14">
          <div className="text-[11px] font-bold uppercase tracking-[0.2em] text-mint mb-3">How it works</div>
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight">Up and running in 60 seconds.</h2>
        </div>

        <div className="space-y-10">
          <Step n={1} title="Sign up free" desc="No credit card, no data subscription. Start with $100,000 of paper cash on the house." />
          <Step n={2} title="Build a portfolio" desc="Seed 10 popular stocks in one click, or browse 546+ tickers with full company names and live quotes." />
  ...
  return (
    <section className="relative overflow-hidden border-b border-border1/50">
      <div className="absolute inset-0 pointer-events-none"
           style={{ background: "radial-gradient(ellipse at center, rgba(52,211,153,0.08), transparent 60%)" }} />
      <div className="relative max-w-4xl mx-auto px-5 sm:px-8 py-20 sm:py-24 text-center">
        <h2 className="text-3xl sm:text-5xl font-bold tracking-tight mb-4">Ready to test your strategy?</h2>
        <p className="text-base sm:text-lg text-ink2 mb-10">Free forever. No card needed. Paper trading from day one.</p>
        <Link href="/register" className="btn-mint text-base !px-8 !py-3.5 inline-flex items-center gap-2 group">
          Get started free
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
               className="w-4 h-4 transition-transform group-hover:translate-x-0.5">
            <polyline points="9 18 15 12 9 6" />
    ...
    <footer className="py-10">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-5 text-[12px] text-muted">
          <a href="https://github.com/vivaanjain2904-spec/vivaan-next" target="_blank" rel="noreferrer" className="hover:text-ink2 transition-colors">GitHub</a>
          <span className="text-border2">·</span>
          <a href="mailto:vivaanjain2904@gmail.com" className="hover:text-ink2 transition-colors">Contact</a>
          <span className="text-border2">·</span>
          <Link href="/login" className="hover:text-ink2 transition-colors">Sign in</Link>
        </div>
      </div>
    </footer>
  );
...
function FeatureCard({ icon, title, desc, delay }: { icon: React.ReactNode; title: string; desc: string; delay?: 1|2|3|4|5|6 }) {
  return (
    <div className={[
      ...
      <h3 className="text-lg font-semibold text-ink mb-2 group-hover:text-mint transition-colors">{title}</h3>
...
const ICON_PROPS = {
  ...
  strokeLinecap: "round" as const, strokeLinejoin: "round" as const, className: "w-5 h-5",
};
function IconTarget()   { return (<svg {...ICON_PROPS}><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>); }
function IconChart()    { return (<svg {...ICON_PROPS}><path d="M3 3v18h18"/><path d="M7 15l4-6 4 4 4-7"/></svg>); }
function IconBell()     { return (<svg {...ICON_PROPS}><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>); }
function IconCpu()      { return (<svg {...ICON_PROPS}><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/><path d="M9 2v2M15 2v2M9 20v2M15 20v2M2 9h2M2 15h2M20 9h2M20 15h2"/></svg>); }
function IconTrending() { return (<svg {...ICON_PROPS}><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>); }
function IconZap()      { return (<svg {...ICON_PROPS}><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>); }
  ...
  return (
    <div className="relative max-w-5xl mx-auto">
      <div className="panel p-4 sm:p-6 text-left relative shadow-2xl shadow-mint/10 backdrop-blur-sm">
        ...
        <div className="text-[10px] font-semibold text-ink2 uppercase tracking-wider mb-2">Recent alerts</div>
        ...
        <div className="text-[10px] font-semibold text-ink2 uppercase tracking-wider mb-2">Holdings</div>
