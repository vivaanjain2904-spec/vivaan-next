...
export default function SettingsPage() {
  ...
  async function saveSettings() {
    const body: any = {
      ...
      alpaca_key: apKey, alpaca_mode: "paper", auto_trade: autoT,
    ...
    <>
      ...
      <div className="panel mb-6">
        <div className="text-sm text-ink2 mb-4 leading-relaxed">
          ...
          automatically place a paper trade via Alpaca and notify your phone with the receipt.
          <br /><br />
        ...
        <input className="input font-mono text-xs" value={apKey} onChange={e => setApKey(e.target.value)}
               placeholder="PKxxxxxxxxxxxxxxx (paper key)" autoComplete="off" />
